...
<aside id="cli-mob-sidebar" class="fixed left-0 top-0 h-full w-72 z-50 bg-[#faf9f8] border-r border-outline-variant/10 flex flex-col py-6 px-4 gap-1 md:hidden overflow-y-auto">
